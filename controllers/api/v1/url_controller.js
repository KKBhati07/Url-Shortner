...
const shorten = async (req, res) => {
    try {
        ...
        if (existing) return res.status(200).json({ shortCode: existing.code, original: existing.original, message: "Short code already exists!" });
        ...
        return res.status(201).json({ shortUrl: newUrl.code, original: url, message: "Short code generated successfully" });
